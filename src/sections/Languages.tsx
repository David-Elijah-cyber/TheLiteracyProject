        ...
        >
          {languageData.map((lang) => (
            <button
              ...
              className={`group text-left bg-white rounded-2xl p-6 shadow-paper hover:shadow-paper-lg transition-all duration-300 hover:-translate-y-1.5 ${
                currentLanguage === lang.code ? 'ring-2 ring-gold' : ''
              }`}
            >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <ArrowRight className={`w-4 h-4 transition-all ${
                      currentLanguage === lang.code 
                        ...
                        : 'text-text-dark/30 group-hover:text-gold group-hover:translate-x-1'
                    }`} />
                  </div>
                </div>
              </div>
